 ...
 *  плагин для arduino IDE https://github.com/esp8266/Arduino-esp8266fs-plugin/releases/tag/0.1.3
 ...
 *  архив с исходниками этого скетча и папки data расположен  тут
 *  http://esp8266-arduinoide.ru/wp-content/uploads/2016/01/WiFiManager-IR-FS.zip
 *  на всякий случай копирую весь проект на git сюда:
 *  
 *  
 *  --- Внутри проекта иммем:---
